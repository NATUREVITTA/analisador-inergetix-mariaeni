...
INSTA_FIXO = "@maria_eni_feltrin"
ZAP_FIXO = "51 99987-0031"
NOME_TERAPEUTA_FIXO = "Maria Eni Feltrin"
...
def gerar_pdf(texto_analise, dados_usuario, nome_terapeuta, info_rodape):
    ...
    pdf.cell(0, 8, txt="Médica e Terapeuta", ln=True, align='R')
...
# ÁREA PRINCIPAL
st.title("🌿 Portal Maria Eni Feltrin")
    ...
    if not upload_pdf or not nome_paciente:
        ...
        with st.spinner("Analisando e Gerando o resultado..."):
            try:
                ...
                Você é uma Médica e Terapeuta Integrativa, com vasta experiência prática em:
